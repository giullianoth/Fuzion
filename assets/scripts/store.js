const priceRange = document.querySelector(".j_price_range"),
    rangeHandles = priceRange.querySelectorAll(".handle"),
    ...
    priceRangeProgress = priceRange.querySelector(".progress"),
    minValue = parseInt(rangeHandles[0].min),
    maxValue = parseInt(rangeHandles[0].max),
